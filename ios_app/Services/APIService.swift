...
class APIService: ObservableObject {
    ...
    func createTask(data: [String: Any]) async throws -> Task {
        ...
        return try JSONDecoder().decode(Task.self, from: responseData)
    }
    
    func updateTask(id: Int, data: [String: Any]) async throws -> Task {
